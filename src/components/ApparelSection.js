        ...
        <div className="row no-gutters">
          <div className="col-md-3">
            <div className="home-category-banner bg-light-orange">
              ...
              <img src={item2} className="img-bg" alt="banner" />
            </div>
          </div>
            ...
            <ul className="row no-gutters bordered-cols">
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item1} alt="item1" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item2} alt="item2" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item3} alt="item3" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item4} alt="item4" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={item5} alt="item5" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    <h6 className="title">Home and kitchen electronic stuff collection</h6>
                    <img className="img-sm float-right" src={item6} alt="item6" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item7} alt="item7" />
              ...
              <li className="col-6 col-lg-3 col-md-4">
                <a href="#" className="item">
                  <div className="card-body">
                    ...
                    <img className="img-sm float-right" src={item6} alt="item8" />
                    <p className="text-muted"><i className="fa fa-map-marker-alt"></i> Guanjou, China</p>
                  </div>
                </a>
              </li>
